defmodule RtsptWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use RtsptWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_users(%{conn: conn} = context) do
    users = Rtspt.AccountsFixtures.users_fixture()
    scope = Rtspt.Accounts.Scope.for_users(users)
